...
from core.data_validator import DataValidator, DataQualityMonitor
...
def test_proxy_pool():
    ...
    try:
        pool = ProxyPool()
        stats = pool.stats()
        print(f"  代理池状态: 可用={stats['available']}, 平均延迟={stats['avg_latency']:.2f}s")
        print("✓ 代理池测试通过")
        return True
    except Exception as e:
...
def main():
    ...
    if passed_tests == total_tests:
        ...
        print("python main.py --keyword 'laptop' --pages 3")
    else:
